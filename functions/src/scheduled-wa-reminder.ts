 ...
 */
export const scheduledWAReminderH60 = onSchedule(
  {
  ...
  async () => {
    ...
    try {
      const fonnteRes = await sendWhatsAppFonnte({
      ...
      await saveWAReminderConfig({ lastSentDate: sentIsoDate }, 'system_scheduler');
