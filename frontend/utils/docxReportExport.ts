      ...
      new TableRow({
        children: [
          new TableCell({
            width: sigCellWidth,
            margins: { top: 80, bottom: 80, left: 80, right: 80 },
            children: buildSigCell('', ack1SignBytes, (!data.acknowledgedBy1Name || data.acknowledgedBy1Name === 'Andrean Bima Pratama') ? 'Habib Mulyana' : data.acknowledgedBy1Name, data.acknowledgedBy1Title || '(Chief Engineer)'),
          }),
          new TableCell({
            width: sigCellWidth,
            margins: { top: 80, bottom: 80, left: 80, right: 80 },
