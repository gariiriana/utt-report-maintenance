...
const CHECKLIST_LABELS = [
    ...
    { key: 'bodyHarness', label: 'Body Harness (Optional)' },
    { key: 'fullBodyHarness', label: 'Full Body Harness (Optional)' },
    { key: 'sarungTanganKaretHighVoltage', label: 'Sarung Tangan Karet High Voltage Resistance (Optional)' },
    { key: 'sarungTanganKaretChemical', label: 'Sarung Tangan Karet Chemical Resistance (Optional)' },
    { key: 'sarungTanganCutResistance', label: 'Sarung Tangan Cut Resistance (Optional)' },
    { key: 'apron', label: 'Apron (Optional)' },
    { key: 'kedokLas', label: 'Kedok Las (Optional)' },
    { key: 'coverShoes', label: 'Cover Shoes (Optional)' },
    { key: 'respirator', label: 'Respirator (Optional)' },
    { key: 'pelindungMata', label: 'Pelindung Mata (Optional)' },
    { key: 'msds', label: 'MSDS (Optional)' },
    { key: 'pitaBaricade', label: 'Pita Baricade (Optional)' },
    { key: 'safetyCone', label: 'Safety Cone (Optional)' },
    { key: 'stikBariket', label: 'Stik Bariket (Optional)' },
    { key: 'underMaintenance', label: 'Under Maintenance (Optional)' },
