...
import { generateCTReportExcel } from '@/service_reports/ct/generateCTReportExcel';
    ...
    <div className="bg-white/95 backdrop-blur-xl border border-sky-100/90 rounded-3xl p-4 sm:p-6 md:p-8 shadow-2xl shadow-sky-900/10 text-slate-800">
      ...
      <div className="mt-10 pt-6 border-t border-slate-200 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <button
            type="button"
            onClick={() => generateCTReportExcel(customerInfo, reportData, timeSpent, photos.map(p => ({ photoBase64: p.preview, description: p.label })))}
