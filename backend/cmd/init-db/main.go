...
func main() {
	...
	initialData := []models.MaintenanceProgress{
		// ELECTRICAL SYSTEM (Total Plan: 636, Yesterday Total: 510)
		...
		// COOLING SYSTEM (Total Plan: 371, Yesterday Total: 142)
		...
		// FIRE SYSTEM (Total Plan: 1116, Yesterday Total: 877)
		...
		// FUEL SYSTEM (Total Plan: 27, Yesterday Total: 27)
		...
		// PESAWAT ANGKUT (Total Plan: 10, Yesterday Total: 3.24)
		...
		// LEAK DETECTION (Total Plan: 115, Yesterday Total: 115)
		...
		// PLUMBING SYSTEM (Total Plan: 38, Yesterday Total: 2.58)
		...
		// GATE & DOOR (Total Plan: 27, Yesterday Total: 0)
		...
		// LIGHTING SYSTEM (Total Plan: 2750, Yesterday Total: 2372)
