...
interface UserData {
  email: string;
  uid: string;
  role: 'admin' | 'engineer' | 'standby_engineer' | 'tde' | 'cbre';
...
interface AuthContextType {
  user: User | null;
  userRole: 'admin' | 'engineer' | 'standby_engineer' | 'tde' | 'cbre' | null;
...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  const [userRole, setUserRole] = useState<'admin' | 'engineer' | 'standby_engineer' | 'tde' | 'cbre' | null>(null);
